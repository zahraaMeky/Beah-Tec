  ...
  return (
    <div className="clearfix">
      <div className="hint-text">
         الصفحة  <b className="px-1">{currentButton}</b> من 
        <b className="px-1"> {notifications.length}</b> 
      </div>
      <ul  dir="rtl" className="pagination">
        <li
          className={`${
        ...
        {numOfPages.map((page, index) => {
          return (
            ...
            >
              <a className="page-link" onClick={() => setCurrentButton(page)}>
                {page}
              </a>
            </li>
          );
